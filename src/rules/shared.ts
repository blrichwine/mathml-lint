...
export const TAG_RULES: Record<string, { children: string[]; attributes: string[]; arity?: { exact?: number; min?: number } }> = {
  ...
  mo: { children: [], attributes: [
    'mathvariant', 'form', 'fence', 'separator', 'stretchy', 'symmetric', 'intent',
    // MathML3 linebreaking attributes
    'linebreak', 'linebreakstyle', 'linebreakmultchar', 'lineleading',
    'indentshift', 'indentalign', 'indentalignfirst', 'indentalignlast', 'indenttarget',
  ] },
  mtext: { children: [], attributes: ['mathvariant', 'intent'] },
  ms: { children: [], attributes: ['mathvariant', 'lquote', 'rquote', 'intent'] },
  mspace: { children: [], attributes: [
    'width', 'height', 'depth',
    // MathML3 linebreaking attributes
    'linebreak', 'indentalign', 'indentshift', 'indentalignfirst', 'indentalignlast', 'indenttarget',
  ] },
  mfrac: { children: [...CHILDREN_PRESENTATION], attributes: ['linethickness', 'bevelled', 'intent'], arity: { exact: 2 } },
  msup: { children: [...CHILDREN_PRESENTATION], attributes: ['superscriptshift', 'intent'], arity: { exact: 2 } },
  msub: { children: [...CHILDREN_PRESENTATION], attributes: ['subscriptshift', 'intent'], arity: { exact: 2 } },
  msubsup: { children: [...CHILDREN_PRESENTATION], attributes: ['subscriptshift', 'superscriptshift', 'intent'], arity: { exact: 3 } },
  ...
  mtable: { children: ['mtr', 'mlabeledtr'], attributes: [
    'columnalign', 'rowalign', 'intent',
    // MathML3 full table attributes
    'align', 'columnlines', 'rowlines', 'frame', 'framespacing',
    'columnwidth', 'equalcolumns', 'equalrows', 'groupalign',
  ...
  mtd: { children: [...CHILDREN_PRESENTATION, 'maligngroup'], attributes: ['rowspan', 'columnspan', 'rowalign', 'columnalign', 'groupalign', 'intent'], arity: { min: 1 } },
